...
description: "Deploy Camofox anti-detection browser server for Hermes Agent — npm install, port configuration, systemd service, and Hermes integration. Load when: 'set up Camofox', 'anti-detection browser', 'camofox browser', 'CAMOFOX_URL', 'stealth browser', or when enabling browser anti-detection for Hermes."
triggers:
  - "Camofox"
  - "camofox"
