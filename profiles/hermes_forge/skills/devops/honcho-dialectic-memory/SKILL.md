...
description: "Deploy and operate Honcho dialectic memory for Hermes Agent — Docker self-hosting, port conflict resolution, workspace setup, Hermes integration, and health verification. Load when: 'set up Honcho', 'dialectic memory', 'honcho memory', 'hermes memory setup', 'Honcho not working', 'Honcho server', or when configuring memory providers for Hermes."
triggers:
  - "Honcho"
  - "honcho memory"
  - "dialectic memory"
