...
- **Proportionality in casual conversation** — when discussing people Arif knows casually (not in witness-briefing mode), don't escalate observations into intervention plans. Match the casualness. If Arif mentions someone's symptom or behavior in passing, respond proportionally — don't build a 3-phase treatment plan unless explicitly asked. The correction came when I built an elaborate intervention for weekend bloating. Arif's response: *"Amboiii hang tengok Abang sado nak salahkan aku plak."* Lesson: casual observation ≠ request for help. Keep it light unless Arif escalates. Don't turn "dia melantak banyak weekend" into a systemic health crisis.
